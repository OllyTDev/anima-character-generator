...
export function deriveSheet(character: CharacterDocument) {
  ...
  return {
    ...
    psychicPointsTotal: totalPsychicPoints(character),
    psychicPointsSpent: permanentPPSpent(character),
    psychicPointsFree: freePPRemaining(character),
    psychicProjectionOffense: psychicProjectionOffense(character),
    psychicProjectionDefense: psychicProjectionDefense(character),
    psychicPowers: learnedPowerSummaries(character),
    psychicNaturalPowers: naturalPsychicPowers(character),
    psychicPowerPotentials: psychicPowers(character),
    psychicDisciplines: masteredDisciplines(character),
