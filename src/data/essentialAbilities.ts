...
import type { EssentialAbilityDef } from "./types";

const disciplineNames = Object.keys(psychicDisciplines.disciplines);
const pathNames = [...magicPaths];
const chars = [...tables.characteristics];
const elements = [...tables.elements];

export const essentialAbilities = {
  advantages: {
    "Access to a Psychic Discipline": {
      DP: 15,
      Gnosis: 5,
      Options: disciplineNames,
      Option_Title: "Select a discipline",
      Incompatible: ["Access to Psychic Disciplines"],
    },
    "Access to Psychic Disciplines": { DP: 30, Gnosis: 5, Incompatible: ["Access to a Psychic Discipline"] },
    "Acute Sense": {
      DP: 10,
      Gnosis: 0,
      Options: ["Hearing", "Sight", "Smell", "Taste", "Touch"],
      Option_Title: "Select the enhanced sense",
    },
    Ambidextrous: { DP: 30, Gnosis: 0 },
    "Amplify Sustained Power": { Category: "Psychic", DP: 30, Gnosis: 5 },
    "Aquatic Breathing": { DP: 10, Gnosis: 0 },
    "Attribute Increased +1": { DP: 20, Gnosis: 0, Options: chars, Option_Title: "Select the characteristic to increase" },
    "Attribute Increased +2": { DP: 40, Gnosis: 5, Options: chars, Option_Title: "Select the characteristic to increase" },
    "Attribute Increased +3": { DP: 60, Gnosis: 15, Options: chars, Option_Title: "Select the characteristic to increase" },
    ...
    "Divine Physical Characteristics": {
      DP: 80,
      Gnosis: 30,
      Incompatible: ["Superhuman Physical Characteristics", "Supernatural Physical Characteristics"],
    },
    "Divine Spiritual Characteristics": {
      DP: 80,
      Gnosis: 35,
      Incompatible: ["Superhuman Spiritual Characteristics", "Supernatural Spiritual Characteristics"],
    },
    ...
    "Natural Immunity to an Element (Half Damage)": {
      DP: 10,
      Gnosis: 20,
      Options: elements,
    ...
    "Natural Immunity to an Element (Complete Immunity)": {
      DP: 10,
      Gnosis: 20,
      Options: elements,
      Option_Title: "Select an element",
    ...
    "Natural Knowledge of a Path 20": {
      ...
      Alternatives: [
        "Natural Knowledge of a Path 40",
        "Natural Knowledge of a Path 60",
        "Natural Knowledge of a Path 80",
        "Natural Knowledge of a Path 90",
      ],
    },
    "Natural Knowledge of a Path 40": {
      Category: "Magic",
    ...
    "Superhuman Physical Characteristics": {
      DP: 20,
      Gnosis: 0,
      Incompatible: ["Divine Physical Characteristics", "Supernatural Physical Characteristics"],
    },
    "Superhuman Spiritual Characteristics": {
      DP: 20,
      Gnosis: 5,
      Incompatible: ["Divine Spiritual Characteristics", "Supernatural Spiritual Characteristics"],
    },
    "Supernatural Physical Characteristics": {
      DP: 40,
      Gnosis: 20,
      Incompatible: ["Divine Physical Characteristics", "Superhuman Physical Characteristics"],
    },
    "Supernatural Spiritual Characteristics": {
      DP: 40,
      Gnosis: 20,
      Incompatible: ["Divine Spiritual Characteristics", "Superhuman Spiritual Characteristics"],
    },
  ...
  } as Record<string, EssentialAbilityDef>,
  disadvantages: {
    ...
    "Natural Vulnerability to an Element (50% More Damage)": {
      DP: -10,
      Gnosis: 20,
      Options: elements,
      Option_Title: "Select an element",
    ...
    "Natural Vulnerability to an Element (Double Damage)": {
      DP: -20,
      Gnosis: 20,
      Options: elements,
      Option_Title: "Select an element",
